...
export const metadata: Metadata = {
  title: "세차용품 | 프리미엄 자동차용품 | 스타일카",
  description: "세차용품 전문 쇼핑몰 스타일카. 32개의 프리미엄 세차용품을 할인가에 만나보세요.",
}
...
export default function CleaningPage() {
  const categories = [
    ...
    { name: "카매트", href: "/categories/carmat", count: 45, active: false },
    { name: "세차용품", href: "/categories/cleaning", count: 32, active: true },
  ...
  const products = [
    {
      ...
      reviews: 156,
      badge: "베스트",
      image: "/placeholder.svg?height=300&width=300&text=청소기",
    },
    {
      id: 8,
      name: "프리미엄 세차 케어 키트",
      ...
      reviews: 89,
      badge: "신상품",
      image: "/placeholder.svg?height=300&width=300&text=세차키트",
    },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav className="text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="font-medium text-gray-900">세차용품</span>
        </nav>
      </div>
      ...
      <section className="bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">세차용품</h1>
          <p className="text-xl text-gray-600">32개의 프리미엄 세차용품을 만나보세요</p>
        </div>
      </section>
